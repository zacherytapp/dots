-- Animations are disabled, see https://wiki.hypr.land/Configuring/Advanced-and-Cool/Animations/
...
-- Curves are kept so animations can be turned back on by flipping `enabled`
-- above and uncommenting the leaves at the bottom of this file.
